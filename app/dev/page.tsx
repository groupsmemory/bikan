...
const PHASES: Phase[] = [
  {
    ...
    tasks: [
      ...
      { id: '1.10', title: 'Environment validation (crash early)', status: 'todo' },
      { id: '1.11', title: 'Error boundaries per route group', status: 'todo' },
      { id: '1.12', title: 'Role-based middleware enforcement', status: 'todo' },
    ],
  },
  {
    id: 'phase-2',
    ...
    tasks: [
      ...
      { id: '2.7', title: 'Email verification flow', status: 'todo' },
      { id: '2.8', title: 'Mastery Gatekeeper server-side', status: 'todo', notes: 'Block di server, bukan hanya UI' },
      { id: '2.9', title: 'Landing page SEO optimization', status: 'todo' },
    ],
  },
  {
    id: 'phase-3',
    ...
    timeline: 'Bulan 2-3',
    tasks: [
      { id: '3.1', title: 'Sentry error monitoring', status: 'todo', notes: '@sentry/nextjs' },
      { id: '3.2', title: 'PostHog analytics', status: 'todo', notes: 'Activation, retention tracking' },
      { id: '3.3', title: 'SHU automation (cron)', status: 'todo', notes: 'Monthly calculateAnnualShu()' },
      { id: '3.4', title: 'Redis rate limiting', status: 'todo', notes: 'Replace in-memory' },
      { id: '3.5', title: 'Modul 2: Persamaan Linear', status: 'todo', notes: 'Content + lessons.ts' },
      { id: '3.6', title: 'UTBK/CPNS expansion', status: 'todo', notes: 'Backlog' },
