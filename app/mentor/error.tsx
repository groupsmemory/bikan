...
/**
 * BIKAN Mentor Route Error Boundary
 * ──────────────────────────────────
 * Catches errors in /mentor routes (SHU dashboard)
 */
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral-base p-6">
      <div className="max-w-sm text-center space-y-5">
        <div className="w-16 h-16 mx-auto rounded-2xl bg-muted-green/10 flex items-center justify-center">
          <Wallet className="w-7 h-7 text-muted-green" />
        </div>
        <h2 className="text-lg font-bold text-muted-blue">Dashboard SHU Error</h2>
        <p className="text-sm text-muted-blue/50 leading-relaxed">
          Terjadi kesalahan saat memuat data pendapatan. Data SHU Anda tetap aman di database.
        </p>
        {error.digest && (
